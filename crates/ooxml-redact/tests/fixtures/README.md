...
Custom XML includes `xsi:nil`, `xsi:type`, and a private schema location to verify that redaction preserves structural instance attributes and removes external schema hints.
