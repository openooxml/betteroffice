...
Source attachment restores shape effects, including outer shadows. Imported
baseline properties and effects persist in subsequent updates.
...
hidden-shape, custom-geometry, comment, list-style, baseline, and effect migrations run
