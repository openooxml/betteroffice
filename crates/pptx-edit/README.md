...
original package with `open_from_update_with_source` imports source comments, list styles and bitmap effects
...
hidden-shape and custom-geometry migrations run first, in order, followed by comments, list styles and bitmap effects; missing starting slide numbers default to one and stay omitted
from package JSON.
