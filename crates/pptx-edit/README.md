...
list styles, explicit numbering restarts, paragraph line spacing, and picture
fills missing from older snapshots.
...
schema-12 line-spacing migration, and schema-13 picture-fill migration.
