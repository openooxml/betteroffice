...
#[test]
fn main_v9_imports_blip_effects_without_losing_edits_or_source_parts() {
    let migrated = DeckSession::open_from_update(MAIN_V9, 31201).unwrap();
    ...
    let attached = DeckSession::open_from_update_with_source(MAIN_V9, SOURCE, 31202).unwrap();
