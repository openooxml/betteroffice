...
The v10 autonumber and baseline fixtures are regenerated by this schema-12
...
The generator asserts schema 12 and verifies that main reopens every fresh seed
without changes. Tests observe separate baseline (10), numbering (11), spacing
(12), and picture-fill (13) transactions. Source attachment restores missing
properties, preserves edits, and persists them for source-free reopening.
