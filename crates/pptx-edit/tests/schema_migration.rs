...
fn released_v1_snapshot_migrates_and_round_trips_as_v10() {
    ...
    assert_eq!(
        ...
        migrated.len(),
        "reopening a v9 snapshot must not migrate again"
    );
}
...
#[test]
fn main_v9_spacing_migrates_once_and_source_restores_it_without_losing_edits() {
    let old = include_bytes!("fixtures/deck-schema-v9-line-spacing.update.bin");
