...
[`run-gradfill-main-v8.update.bin`](../../../pptx-edit/tests/fixtures/run-gradfill-main-v8.update.bin)
was generated by main at `1d0f41d9` from this exact deck with client ID 299 and
the locked dependencies. It retains schema 8's original unset run colors.
Opening it with the source deck and saving on this branch preserves every part,
including the XML declaration's original whitespace; an unchanged XML tree is
