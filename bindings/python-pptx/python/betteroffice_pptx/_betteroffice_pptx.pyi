...
class Presentation:
    ...
    def read_content_json(self, request: str) -> str: ...
    ...
    def export_markdown_json(self, options: str) -> str: ...
...
def export_pptx_structured_json(data: bytes, options: str) -> str: ...
def export_pptx_markdown_json(data: bytes, options: str) -> str: ...
def render_pptx_markdown_json(content: str, options: str) -> str: ...
