...
async function writeTestFixtures(): Promise<void> {
  ...
  await writeZip(path.join(root, 'crates/vsdx-parse/tests/fixtures/export-mixed-pages.vsdx'), {
    ...
    'visio/pages/_rels/page2.xml.rels': "<Relationships xmlns='http://schemas.openxmlformats.org/officeDocument/2006/relationships'><Relationship Id='rIdEmf' Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/image' Target='../media/vector.emf'/><Relationship Id='rIdWmf' Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/image' Target='../media/vector.wmf'/><Relationship Id='rIdUnsupported' Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/image' Target='../media/unsupported.tiff'/></Relationships>",
