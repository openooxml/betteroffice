...
export const PACKAGES = [
  {
    ...
    desc: "Framework-free .docx core — parsing, CRDT editing and page layout on the Rust engine, with version-checked atomic text, paragraph and content-control batches, content-control discovery, and structured JSON and Markdown export.",
  },
  {
    name: "@betteroffice/docx-react",
    desc: "The DOCX editor as a drop-in React component, with host-controlled saving, awaited input flushing, version-checked edit batches, and content-control discovery.",
  },
  {
