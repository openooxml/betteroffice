...
export const PACKAGES = [
  ...
  },
  {
    ...
    desc: "The DOCX editor as a drop-in React component, with host-controlled saving, awaited input flushing, version-checked edit batches, and page-referenced structured export.",
  },
  {
