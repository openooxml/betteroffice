...
const INTRO =
  "Live demos of the BetterOffice engines. Each demo opens a real file in the browser and runs on native OOXML engines written in Rust and compiled to WebAssembly. Nothing is uploaded; parsing and rendering happen on the page.";
...
This page is an interactive ${surface}, so the demo itself needs a browser. The
...
- [\`@betteroffice/${format.id}-react\`](https://www.npmjs.com/package/@betteroffice/${format.id}-react) — React ${surface}
`;
}
