...
| --- | --- | --- | --- |
| DOCX | `@betteroffice/docx`, `@betteroffice/docx-react` | `betteroffice-docx` | not published yet |
...
`betteroffice-xlsx`. The DOCX and PPTX bindings are built and tested in the
repository but have no PyPI project yet.
