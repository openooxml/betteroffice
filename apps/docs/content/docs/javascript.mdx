...
| `@betteroffice/pptx-react` | The slides editor and viewer as a React component, with a command store, composable toolbar parts, and flushed version-checked edit batches on its editor API. |
