...
On the 165-workbook calculation benchmark, which strips cached values and compares against Excel's own full rebuild, this moves the corpus from 92.0076% to 99.4547% of cells matching Excel — 129 of 165 workbooks now match exactly, up from 49 — with no workbook regressing. LibreOffice scores 85.8713% on the same corpus.
