...
The fallback now keeps the paragraph on one line and gives every run a conservative, script-neutral slot. Runs no longer overprint; paragraphs that need real font metrics continue to overflow rather than relying on guessed line breaks.
