...
export interface DiagramHandle {
  ...
  transformShape(pageId: string, shapeId: string, xFormula: string, yFormula: string, widthFormula: string, heightFormula: string): [CellFormulaReceipt, CellFormulaReceipt, CellFormulaReceipt, CellFormulaReceipt];
...
export function openDiagram(bytes: Uint8Array, options: OpenDiagramOptions = {}): DiagramHandle {
  ...
  return {
    ...
    transformShape: (pageId, shapeId, xFormula, yFormula, widthFormula, heightFormula) => json(() => doc.transformShapeJson(JSON.stringify({ pageId, shapeId, xFormula, yFormula, widthFormula, heightFormula })), true),
