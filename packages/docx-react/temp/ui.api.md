## API Report File for "@betteroffice/docx-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@betteroffice/docx/types/agentApi';
import { AIAction } from '@betteroffice/docx/types/agentApi';
import { ColorValue } from '@betteroffice/docx/types/document';
import { createDefaultFindOptions } from '@betteroffice/docx/utils/findReplace';
import { createDefaultListState } from '@betteroffice/docx/utils/listState';
import { createSearchPattern } from '@betteroffice/docx/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@betteroffice/docx/types/document';
import { escapeRegexString } from '@betteroffice/docx/utils/findReplace';
import { findAllMatches } from '@betteroffice/docx/utils/findReplace';
import { findInDocument } from '@betteroffice/docx/utils/findReplace';
import { findInParagraph } from '@betteroffice/docx/utils/findReplace';
import { FindMatch } from '@betteroffice/docx/utils/findReplace';
import { FindOptions } from '@betteroffice/docx/utils/findReplace';
import { FindResult } from '@betteroffice/docx/utils/findReplace';
import { FontOption } from '@betteroffice/docx/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@betteroffice/docx';
import { getDefaultHighlightOptions } from '@betteroffice/docx/utils/findReplace';
import { getDefaultPrintOptions } from '@betteroffice/docx';
import { getMatchCountText } from '@betteroffice/docx/utils/findReplace';
import { HighlightOptions } from '@betteroffice/docx/utils/findReplace';
import { isEmptySearch } from '@betteroffice/docx/utils/findReplace';
import { isPrintSupported } from '@betteroffice/docx';
import { ListState } from '@betteroffice/docx/utils/listState';
import { openPrintWindow } from '@betteroffice/docx';
import { ParagraphAlignment } from '@betteroffice/docx/types/document';
import { ParsedClipboardContent } from '@betteroffice/docx/utils';
import { parsePageRange } from '@betteroffice/docx';
import { PrintOptions } from '@betteroffice/docx';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@betteroffice/docx/utils/findReplace';
import { replaceFirstInContent } from '@betteroffice/docx/utils/findReplace';
import { scrollToMatch } from '@betteroffice/docx/utils/findReplace';
import { SectionProperties } from '@betteroffice/docx/types/document';
import { SelectionContext } from '@betteroffice/docx/types/agentApi';
import { Style } from '@betteroffice/docx/types/document';
import { StyleType } from '@betteroffice/docx/types/document';
import { Table } from '@betteroffice/docx/types/document';
import { TableCell } from '@betteroffice/docx/types/document';
import { TabStop } from '@betteroffice/docx/types/document';
import { Theme } from '@betteroffice/docx/types/document';
import { TranslationKey } from '@betteroffice/docx-i18n';
import { triggerPrint } from '@betteroffice/docx';
