...
import { createTemplatePlugin as createTemplateProseMirrorPlugin } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { EditorPluginCore } from '@betteroffice/docx/plugin-api';
import { EditorView } from 'prosemirror-view';
import { getTemplateTags as getTemplatePluginTags } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { PanelConfig } from '@betteroffice/docx/plugin-api';
import { PluginPanelProps } from '@betteroffice/docx/plugin-api';
import { PositionCoordinates } from '@betteroffice/docx/plugin-api';
import * as React_2 from 'react';
import { ReactNode } from 'react';
import { RenderedDomContext } from '@betteroffice/docx/plugin-api';
import { RenderedDomContextImpl } from '@betteroffice/docx/plugin-api/RenderedDomContext';
import { setHoveredElement } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { setSelectedElement } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { SidebarItem } from '@betteroffice/docx/plugin-api';
import { SidebarItemContext } from '@betteroffice/docx/plugin-api';
import { TagType } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { TEMPLATE_DECORATION_STYLES } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { templatePluginKey } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';
import { TemplateTag } from '@betteroffice/docx/prosemirror/template/prosemirror-plugin';

export { createCanvasHostProjector }
