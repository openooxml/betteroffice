...
export { halfPointsToPoints, pointsToHalfPoints } from '@betteroffice/docx/utils/units';
...
export function FontSizePicker({
  ...
  const handleSizeSelect = useCallback(
    (size: number) => {
      // Closing the dropdown unmounts the focused text input. Do not let its
      // trailing blur re-commit the old display value over the chosen option.
