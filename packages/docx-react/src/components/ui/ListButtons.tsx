...
import type { NumberFormat } from '@betteroffice/docx/types/document';
...
export type { ListType, ListState } from '@betteroffice/docx/utils/listState';
import type { ListState } from '@betteroffice/docx/utils/listState';
...
export {
  ...
  toggleListType,
} from '@betteroffice/docx/utils/listState';
