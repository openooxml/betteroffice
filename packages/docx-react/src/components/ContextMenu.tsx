...
import type { AIAction, SelectionContext } from '@betteroffice/docx/types/agentApi';
import { getActionDescription, DEFAULT_AI_ACTIONS } from '@betteroffice/docx/types/agentApi';
