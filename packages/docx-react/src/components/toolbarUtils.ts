...
import type { TextFormatting, ParagraphFormatting, Theme } from '@betteroffice/docx/types/document';
...
} from '@betteroffice/docx/utils/highlightColors';
import { mapHexToHighlightName } from '@betteroffice/docx/utils/highlightColors';
