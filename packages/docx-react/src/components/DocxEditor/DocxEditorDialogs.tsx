...
export function DocxEditorDialogs({
  ...
  tableProperties: Record<string, unknown> | undefined;
  onTablePropertiesApply: (properties: TableProperties) => void;
  // Split cell
    ...
    <Suspense fallback={null}>
      ...
      {tablePropsOpen && (
        <TablePropertiesDialog
          ...
          onApply={onTablePropertiesApply}
