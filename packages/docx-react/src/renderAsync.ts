 ...
 *
 * Returns an `EditorHandle` (from @betteroffice/docx) that works with
 * any framework implementation.
 *
 * Usage:
 * ```ts
 * import { renderAsync } from '@betteroffice/docx-react';
 *
...
import type { EditorHandle } from '@betteroffice/docx';
