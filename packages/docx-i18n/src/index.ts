/**
 * Shared locale data, types, and runtime helpers for the @openooxml
 * docx adapters.
 *
...
// `packages/docx-i18n/*.json` filenames whenever `bun run i18n:codegen`
 ...
 * @example
 * ```ts
 * import { deepMerge, createT, en, de } from '@betteroffice/docx-i18n';
