...
function source(rank: number): Uint8Array {
...
test.each([0, 20, 4_294_967_295, -1, 1.5, 4_294_967_296])('both import paths retain image drawing order %d', async (rank) => {
  const bytes = source(rank);
