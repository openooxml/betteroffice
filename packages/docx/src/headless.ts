 ...
 * @example
 * ```ts
 * import { DocumentAgent, parseDocx, pluginRegistry } from '@betteroffice/docx/headless';
 * import { docxtemplaterPlugin } from '@betteroffice/docx/core-plugins';
 *
 * // Register plugins
