...
export const editsession_find_content_controls_json: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
...
export const editsession_selection_text_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number, number];
...
export const editsession_validate_edits_json: (a: number, b: number, c: number) => [number, number, number, number];
export const editsession_version: (a: number) => [number, number];
...
export const find_docx_content_controls_json: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
