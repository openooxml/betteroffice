...
/** Tracks the size of the workspace the docks share with the slide while plugins are installed. */
...
function PanelBody({
  ...
  return (
    <div
      ...
      className="pptx-plugin-dock__panel"
 ...
 * a side dock shows only its tabs, and a tab opens its panel as a drawer over the slide that
...
export function PluginDock({
  ...
  return (
    <section
      {...PLUGIN_CHROME}
      className={`pptx-plugin-dock pptx-plugin-dock--${placement}`}
