...
export const pptxdocument_anchorCaretJson: (a: number, b: number, c: number) => [number, number, number, number];
...
export const pptxdocument_resolveCaretAnchorJson: (a: number, b: number, c: number) => [number, number, number, number];
